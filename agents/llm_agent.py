...
@agent(
    name="LLM Agent",
    description="Processes text using LLM",
    version="1.0.0"
)
class LLMAgentAgent(A2AServer):
    
    def __init__(self):
        super().__init__()
        self.url = "None"
        self.goal = "Transform and analyze text using LLM capabilities"
        self.tags = ['llm', 'text']
        self.port = 5003
    ...
    def process_input(self, **kwargs):
        ...
        try:
            ...
            for required_input in ['text', 'max_length']:
