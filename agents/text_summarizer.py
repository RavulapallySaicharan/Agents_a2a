...
@agent(
    ...
    description="Creates concise summaries of long text while preserving key information",
    version="1.0.0"
)
class TextSummarizerAgent(A2AServer):
    
    def __init__(self):
        super().__init__()
        self.url = "None"
        self.goal = "Generate accurate and coherent summaries of input text"
        self.tags = ['nlp', 'summarization', 'text-processing']
        self.port = 5012
...
if __name__ == "__main__":
    ...
    port = int(os.getenv("AGENT_PORT", 5012))
